...
``` bash
curl -s https://raw.githubusercontent.com/ai-maxmind/Dockerization/refs/heads/main/odoo/odoo-19-docker-compose/run.sh | bash -s odoo-one 10019 20019
```
and/or run the following to set up another Odoo instance @ `localhost:11019` (default master password: `admin`):

``` bash
curl -s https://raw.githubusercontent.com/ai-maxmind/Dockerization/refs/heads/main/odoo/odoo-19-docker-compose/run.sh | bash -s odoo-two 11019 21019
```
