...
``` bash
curl -s https://raw.githubusercontent.com/ai-maxmind/Dockerization/refs/heads/main/odoo/odoo-14-docker-compose/run.sh | sudo bash -s odoo-one 10014 20014
```

to set up first Odoo instance @ `localhost:10014` (default master password: `admin`)

and

``` bash
curl -s https://raw.githubusercontent.com/ai-maxmind/Dockerization/refs/heads/main/odoo/odoo-14-docker-compose/run.sh | sudo bash -s odoo-two 11014 21014
```

to set up another Odoo instance @ `localhost:11014` (default master password: `admin`)
...
$ cd odoo/odoo-14-docker-compose
