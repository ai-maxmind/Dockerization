...
``` bash
curl -s https://raw.githubusercontent.com/codedeep79/odoo-docker-compose/refs/heads/main/odoo-15-docker-compose/run.sh | sudo bash -s odoo-one 10015 20015
```
...
``` bash
curl -s https://raw.githubusercontent.com/codedeep79/odoo-docker-compose/refs/heads/main/odoo-15-docker-compose/run.sh | sudo bash -s odoo-two 11015 21015
```
